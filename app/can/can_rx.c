...
#define MOD_NAME  "CRX "
#include "log.h"
/* Phase 3 / C3: ack. g_can_rx_timeout_table[] 是手维护表 (DBC GenMsgSendType 驱动)，不是 AUTOGEN。原 AUTOGENERATED 标记下方说明已澄清 cycle 字段来源；Phase 3 / gen_ipk_runtime.py 落地后将由该工具生成。Marker closed. */
