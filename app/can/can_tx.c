 ...
 *
 * @details Index = TX slot 0..TX_COUNT-1 (NOT ipk index). Each row
 *          is one TX message; the table holds exactly the IPK TX
 *          set, no RX placeholders.  prv_build_tx_table() walks
 *          can_msg_descs_ipk[] in TX order and feeds the matching
 *          slot to this table to seed s_tx.payloads[].cycle_ms.
 *
