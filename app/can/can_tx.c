...
static const u16 g_can_tx_cycle_table[CAN_DB_IPK_TX_COUNT] = {
    /*   0 IPK_EngineService                (TX) */ 1000u,
    /*   1 IPK_STS                          (TX) */ 100u,
    /*   2 IPK_SettingRequest               (TX) */ 100u,
    /*   3 IPK_Fuel_Sts                     (TX) */ 100u,
    /*   4 IPK_TotalOdometer                (TX) */ 1000u,
    /*   5 IPK_DateTime_Info                (TX) */ 500u,
    /*   6 IPK_Fuel_Info                    (TX) */ 200u,
    /*   7 IPK_ODO_Consump                  (TX) */ 1000u,
    /*   8 NWM_IPK                          (TX) */ 0u,
};
